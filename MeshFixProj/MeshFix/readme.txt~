(1) $ cd JMeshExt-1.0alpha_src
    $ make
(2) $ cd JMeshLib-1.2
      makeconf: line 25 -- add -DIS64BITPLATFORM (for 64 bit machine)
(3) $ cd OpenNL3.2.1
    $ ./configure
    $ cd build/Linux-Release
    $ cmake-gui ../../ (change the forlder dir)
    $ make
(4) $ cd SupperLU_4.3
    $ cp /MAKE_INC/make.linux ./make.inc
     make.inc: line 24 (change the root to own machine)
