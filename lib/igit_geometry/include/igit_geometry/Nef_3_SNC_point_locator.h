...
//#endif
#include <igit_geometry/Nef_3_SNC_k3_tree_traits.h>
#include <igit_geometry/Nef_3_K3_tree.h>
#include <igit_geometry/Unique_hash_map.h>
#include <igit_geometry/Timer.h>
...
public:
  SNC_point_locator_by_spatial_subdivision() : 
    initialized(false), candidate_provider(0) {}//by lyon
