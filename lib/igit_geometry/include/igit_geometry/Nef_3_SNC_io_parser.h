...
#include <igit_geometry/Nef_2_Object_index.h>
#include <igit_geometry/Nef_S2_Normalizing.h>
#include <vector>
#include <igit_geometry/Fraction_traits.h>
#include <igit_geometry/Homogeneous_converter.h>
#include <igit_geometry/Cartesian_converter.h>
