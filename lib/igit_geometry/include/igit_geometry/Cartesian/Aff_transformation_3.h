...
#include <igit_geometry/Cartesian/Aff_transformation_rep_3.h>
#include <igit_geometry/Cartesian/Translation_rep_3.h>
#include <igit_geometry/Cartesian/Scaling_rep_3.h>
